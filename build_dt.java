...
public class build_dt {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		args = new String[6];
		args[0] = "train.vectors.txt";
		args[1] = "test.vectors.txt";
		args[2] = "20";
		args[3] = "0";
		args[4] = "model_20_0";
		args[5] = "sys_20_0";
	...
	private static Map<String, Map<String, Integer>> classification(DecisionTree dt, String inputPath, BufferedWriter bw) throws IOException {
		...
		while((line = r.readLine()) != null) {
			...
			resOut.append(inputPath+"_line:"+lineNum+" ");
			while(!order.isEmpty()) {
	...
	*/
	...
	private static DecisionTree ID3() throws IOException {
		...
		//c.d("number of instance at begining: "+allInstanceIds.size());
		ID3Helper(root, allInstanceIds);
		return new DecisionTree(root);
	}
	
	private static void ID3Helper(DtNode curNode, Map<Integer, String> curIns) throws IOException {
		...
		curNode.featName = feature2Choose;
		//<draw branches>
		DtNode n0 = new DtNode(curNode, "0");
		DtNode n1 = new DtNode(curNode, "1");
	...
	private static void ID3step3Helper(String parentFirstCate, DtNode curNode, Map<Integer, String> sv, Set<String> svCate) throws IOException {
	...
	private static void finishBranch(DtNode curNode, Map<Integer, String> curIns) throws IOException {
	...
	public static Map<String, String> traceBack(DtNode n) {
